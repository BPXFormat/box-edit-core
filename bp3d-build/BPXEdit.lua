...
local function build1(ctx, args)
    ...
    elseif bp3d.util.utf8.contains(ctx.target, "ios-sim") then
        bp3d.util.table.concat(args, { "-destination", "generic/platform=iOS Simulator" })
...
function BPXEdit:prePackage(ctx, artifacts)
    ...
    elseif bp3d.util.utf8.contains(ctx.target, "ios-sim") then
        artifacts:add(bp3d.build.Artifact.resource(path:join("Debug-iphonesimulator/BPXEdit.framework"), "BPXEdit.framework"))
    elseif bp3d.util.utf8.contains(ctx.target, "ios") then
